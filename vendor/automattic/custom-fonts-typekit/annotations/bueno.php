...
add_filter( 'typekit_add_font_category_rules', function( $category_rules ) {
	...
	TypekitTheme::add_font_category_rule( $category_rules, 'body-text',
		'body',
		array(
			array( 'property' => 'font', 'value' => '14px Georgia, Times, Serif' ),
		)
	);
	...
	TypekitTheme::add_font_category_rule( $category_rules, 'body-text',
		...
		array(
			...
			array( 'property' => 'font-family', 'value' => 'Impact, Helvetica, arial, sans-serif' ),
		)
	);
	...
	TypekitTheme::add_font_category_rule( $category_rules, 'site-title',
		'.site-title',
		array(
			array( 'property' => 'font', 'value' => '72px/58px Impact,Helvetica,arial,sans-serif' ),
		)
	);
