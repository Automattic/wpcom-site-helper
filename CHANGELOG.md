...
- Features: add the ability to explicity check if feature is available on legacy gating
...
- Enable wp-admin JS error reporting on 40% of sites, to keep up with the React 19 experiment rollout.
...
- Coming Soon: Revert the platform Coming Soon fallback for sites without a wpcom_public_coming_soon option row. It put launched sites whose platform value was stale into Coming Soon.
